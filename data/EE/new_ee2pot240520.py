            ...
            for idx in range(len(tag[id])):
                ...
                if len(index[id][idx])>2:
                    ...
                    if index[id][idx][0] > index[id][idx][-2]:
                        tmp.append(str(min(index[id][idx][0]-sentence_start[id],index[id][idx][-2]-sentence_start[id]))+','+str(max(index[id][idx][0]-sentence_start[id],index[id][idx][-2]-sentence_start[id])+1)+' r_'+tag[id][idx])
                    else:
                        tmp.append(str(min(index[id][idx][0]-sentence_start[id],index[id][idx][-2]-sentence_start[id]))+','+str(max(index[id][idx][0]-sentence_start[id],index[id][idx][-2]-sentence_start[id])+1)+' '+tag[id][idx])
                else:
...
def ace():
    ...
    pot2file('./ACE/pot_train_0520.txt',sen,tag,index,sentence_start)
    print(len(sentences)) 
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_dev_0520.txt',sen,tag,index,sentence_start)
    # print(len(sentences))
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_test_0520.txt',sen,tag,index,sentence_start)
