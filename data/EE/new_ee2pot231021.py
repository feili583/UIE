...
def ace():
    ...
    # pot2file('./ACE/pot_train_com.txt',sen,tag,index,sentence_start)
    # print(len(sentences))
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_dev_com.txt',sen,tag,index,sentence_start)
    # print(len(sentences))
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_test_com.txt',sen,tag,index,sentence_start)
...
def ace_add():
    ...
    # ace_add_file('./ACE_add/pot_train_com.txt',train_sentences,train_tags)

    # test_sentences,test_tags=ace_add_pot(test_data)
    # ace_add_file('./ACE_add/pot_test_com.txt',test_sentences,test_tags)

    # dev_sentences,dev_tags=ace_add_pot(dev_data)
    # ace_add_file('./ACE_add/pot_dev_com.txt',dev_sentences,dev_tags)
