            ...
            for idx in range(len(tag[id])):
                ...
                if len(index[id][idx])>2:
                    ...
                    if index[id][idx][0] < index[id][idx][-2]:
                        all_tmp.append(str(index[id][idx][1] - sentence_start[id] + 1) + ',' + str(index[id][idx][-2] - sentence_start[id]) + ' ' + tag[id][idx])
                        tmp.append(str(index[id][idx][1] - sentence_start[id] + 1) + ',' + str(index[id][idx][-2] - sentence_start[id]) + ' ' + tag[id][idx])
                    else:
                        all_tmp.append(str(index[id][idx][-1] - sentence_start[id] + 1) + ',' + str(index[id][idx][0] - sentence_start[id]) + ' ' + 'r_' + tag[id][idx])
                        tmp.append(str(index[id][idx][-1] - sentence_start[id] + 1) + ',' + str(index[id][idx][0] - sentence_start[id]) + ' ' + 'r_' + tag[id][idx])
...
def ace():
    ...
    pot2file('./ACE/pot_train_0129.txt',sen,tag,index,sentence_start)
    print(len(sentences)) 
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_dev_0129.txt',sen,tag,index,sentence_start)
    # print(len(sentences))
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_test_0129.txt',sen,tag,index,sentence_start)
...
def ace_only_relation():
    ...
    for i in range(len(sentences)):
        temp_list.append([])
    sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,temp_list,sentence_start)
    pot2file('./ACE_only_relation/pot_train_0129.txt',sen,tag,index,sentence_start)

    # ace_data=get_data('./ACE/dev.json')
    # doc_key,sentences,ner,relations,events,sentence_start=get_ace(ace_data)
    # dic_to_file('./ACE/doc_dev.json',doc_key)
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,temp_list,sentence_start)
    # pot2file('./ACE_only_relation/pot_dev_0129.txt',sen,tag,index,sentence_start)

    # ace_data=get_data('./ACE/test.json')
    # doc_key,sentences,ner,relations,events,sentence_start=get_ace(ace_data)
    # dic_to_file('./ACE/doc_test.json',doc_key)
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,temp_list,sentence_start)
    # pot2file('./ACE_only_relation/pot_test_0129.txt',sen,tag,index,sentence_start)
