...
def ace2pot(sentences,ner,relations,events,sentence_start):
    ...
    for id in range(len(sentences)):
        ...
        for relation in relations[id]:
            ...
            # relation_tag.append(relation[-1])
            # relation_index.append(relation[0:2])
            # relation_tag.append(relation[-1])
            # relation_index.append(relation[2:-1])
        ...
        tag.append(relation_tag)
        # tag.append(event_tag)
        index.append(relation_index)
...
def ace():
    ...
    pot2file('./ACE/pot_train_0505.txt',sen,tag,index,sentence_start)
    print(len(sentences)) 
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_dev_0505.txt',sen,tag,index,sentence_start)
    # print(len(sentences))
    ...
    # sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    # pot2file('./ACE/pot_test_0505.txt',sen,tag,index,sentence_start)
