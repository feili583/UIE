...
def ace():
    ...
    pot2file('./ACE/pot_train_1025.txt',sen,tag,index,sentence_start)
    print(len(sentences))
    ...
    sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    pot2file('./ACE/pot_dev_1025.txt',sen,tag,index,sentence_start)
    print(len(sentences))
    ...
    sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,events,sentence_start)
    pot2file('./ACE/pot_test_1025.txt',sen,tag,index,sentence_start)
...
def ace_only_relation():
    ...
    for i in range(len(sentences)):
        temp_list.append([])
    sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,temp_list,sentence_start)
    pot2file('./ACE_only_relation/pot_train_1031.txt',sen,tag,index,sentence_start)

    ace_data=get_data('./ACE/dev.json')
    doc_key,sentences,ner,relations,events,sentence_start=get_ace(ace_data)
    dic_to_file('./ACE/doc_dev.json',doc_key)
    sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,temp_list,sentence_start)
    pot2file('./ACE_only_relation/pot_dev_1031.txt',sen,tag,index,sentence_start)

    ace_data=get_data('./ACE/test.json')
    doc_key,sentences,ner,relations,events,sentence_start=get_ace(ace_data)
    dic_to_file('./ACE/doc_test.json',doc_key)
    sen,tag,index,sentence_start=ace2pot(sentences,ner,relations,temp_list,sentence_start)
    pot2file('./ACE_only_relation/pot_test_1031.txt',sen,tag,index,sentence_start)
...
def ace_add_pot(data):
    ...
    print('event_tags:',len(event_tags),len(set(event_tags)))
    print('role_tags:',len(role_tags),len(set(role_tags)))
    print('all_tags:',len(ner_tags+relation_tags+event_tags+role_tags),set(event_tags+role_tags))
    print(len(set(ner_tags+relation_tags+event_tags+role_tags)))
    print(len(set(role_tags).intersection(set(relation_tags))),set(role_tags).intersection(set(relation_tags)))
...
def ace_add():
    ...
    ace_add_file('./ACE_add/pot_train_1025.txt',train_sentences,train_tags, train_all_tags)

    test_sentences,test_tags, test_all_tags=ace_add_pot(test_data)
    ace_add_file('./ACE_add/pot_test_1025.txt',test_sentences,test_tags, test_all_tags)

    dev_sentences,dev_tags, dev_all_tags=ace_add_pot(dev_data)
    ace_add_file('./ACE_add/pot_dev_1025.txt',dev_sentences,dev_tags, dev_all_tags)
